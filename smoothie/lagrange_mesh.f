! works for any real interactions, but not for complex potentials
! Lagrange mesh method works for different types of interaction
! S-matrix form for real interaction and complex interaction are different
! but the complex interaction form also works for the real interaction
