...
The GUI provides an intuitive interface with forms, real-time plotting, and output monitoring. See the [GUI section](#-graphical-user-interface) below for details.
